        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-blue-50 transition-colors">
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ $tupla->cotizacion_id }}</td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">${{ number_format($tupla->precio_total, 2) }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
