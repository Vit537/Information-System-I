<div class="p-6 bg-gray-50 overflow-y-auto">
    <h1 class="text-3xl font-bold mb-6 text-center">Orden de Compra</h1>

    <div class="mb-6">
        <label for="proveedor_id" class="block text-lg font-medium text-gray-700 mb-2">Selecciona un proveedor</label>
        <select id="proveedor_id" wire:model.live="prov_id" name="proveedor_id" class="w-full p-3 rounded-lg border border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none">
