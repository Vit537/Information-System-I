    ...
    <div class=" flex items-center justify-center">
        <form action="{{ route('persona.update', [$persona->id]) }}" method="POST"
            ...
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-md-9">
                    <input name="nombre" type="text" value="{{ $persona->nombre }}" class="form-control" id="nombre"
            ...
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-md-9">
                    <input name="correo" type="email" value="{{ $persona->correo }}" class="form-control" id="email"
            ...
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-md-9">
                    <input name="confirmacion_contrasena" type="password" class="form-control" id="password_confirmation"
                        placeholder="Repite tu contraseña" value="{{ 12345678 }}">
                </div>
            </div> --
