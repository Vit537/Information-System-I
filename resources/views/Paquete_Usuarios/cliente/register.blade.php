...
{{-- <div class="container d-flex min-vh-100 align-items-center">
    <form action="{{ route('cliente.verify') }}" method="POST" class="m-auto bg-white p-5 rounded shadow-lg" style="max-width: 800px;">
        @csrf
        ...
        <div class="row mb-3 align-items-center">
            ...
            <div class="col-md-9">
                <input name="razon" type="text" value="{{ old('razon') }}" class="form-control" id="razon" placeholder="Ej: Muebles modernos S.A.">
                @error('razon')
                    <div class="text-danger mt-1"><small><strong>{{ $message }}</strong></small></div>
                @enderror
            </div>
        ...
        <div class="row mb-3 align-items-center">
            <div class="col-md-3 text-md-end">
                <label for="TCliente" class="form-label">Tipo cliente</label>
            </div>
            <div class="col-md-9">
                <input name="TCliente" type="text" value="{{ old('TCliente') }}" class="form-control" id="TCliente" placeholder="Ej: empresa, persona individual">
                @error('TCliente')
                    <div class="text-danger mt-1"><small><strong>{{ $message }}</strong></small></div>
                @enderror
            </div>
...
<div class="flex items-center justify-center">
    <form action="{{ route('cliente.verify') }}" method="POST" class="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md space-y-6" >
        @csrf
        <h2 class="text-2xl font-bold text-center text-gray-800">Registro de cliente</h2>
