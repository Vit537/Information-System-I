    ...
    <div class="documento">
                    ...
                    <td style="text-align: left; border:none;  ">
                        <div style=" border:none; width:300px">
                            ...
                            <div class="info-line">
                                ...
                                <span>{{$datos[0]->proveedor->persona->nombre}}</span>
                                {{-- <span>Juan Pérez</span> --}}
                            </div>

                            <div class="info-line">
                                <strong>Usuario que solicita el reporte.:</strong>
                                <span>{{$datos[0]->persona->nombre}}</span>
                                {{-- {{-- <span>Robinson Neira</span> --}}
                            </div>
                            <div class="info-line">
                                <strong>Fono:</strong>
                                <span>{{$datos[0]->persona->telefono}}</span>
                            </div>
                            <div class="info-line">
                                <strong>FAX:</strong>
        ...
        <table style="width: 100%; table-layout: fixed; border-collapse: collapse;">
            ...
            <th style="border: 1px solid #333; padding: 6px; width: 20%;">Total</th> --}}
                    ...
                    <th>Total</th> --}}
                    <th style="">N° de compra</th>
                    <th style=" ">Nombre Proveedor/Empresa</th>
                    <th class="border border-gray-300 px-2 py-1">Fecha/Hora</th>
                    <th class="border border-gray-300 px-2 py-1">Direccion</th>
            ...
            <tbody>
                ...
                @foreach ($datos as $fila)
                    ...
                    <tr>
                        <td style="">{{ $fila->id }}</td>
                        <td class="border px-2 py-1">{{ $fila->proveedor->persona->nombre }}</td>
                        <td class="border px-2 py-1">{{ $fila->created_at }}</td>
                        <td class="border px-2 py-1">{{ $fila->proveedor->persona->direccion }}</td>
